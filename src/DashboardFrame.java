...
public class DashboardFrame extends JFrame {
    ...
    private List<ModuleConfig> buildModules(UserSession s) {
        ...
        if (s.isAdmin()) {
            ...
            list.add(flights(false, false, false, "WHERE f.status !='Cancelled'"));
    ...
    private ModuleConfig flights(boolean a, boolean e, boolean d, String extra) {
        ...
        return new ModuleConfig("Flights", "✈️", "Flight", "flight_id", q,
                new String[] { "ID", "Flight No", "Departure", "Arrival", "Status", "Aircraft ID", "From", "To",
                        "Gate ID", "Aircraft Model", "Aircraft Capacity", "Source Airport", "Source City",
                        "Dest Airport", "Dest City", "Terminal", "Gate Number", "Airline Name", "Airline IATA" },
                new String[] { "flight_id", "flight_number", "departure_time", "arrival_time", "status", "aircraft_id",
                        "src", "dst", "gate_id", "model", "capacity", "src_name", "src_city", "dst_name", "dst_city",
                        "terminal", "gate_number", "airline_name", "airline_iata" },
    ...
    private ModuleConfig bookings(boolean a, boolean e, boolean d, String filter) {
        ...
        return new ModuleConfig("Bookings", "📋", "Booking", "booking_id", q,
                new String[] { "ID", "Reference", "Status", "Passenger ID", "Flight ID", "Flight No",
                        "Passenger First Name", "Passenger Last Name", "Passport No", "Email", "Departure Time",
                        "Flight Status", "Aircraft Model", "Airline Name", "Source Airport", "Dest Airport" },
                new String[] { "booking_id", "booking_reference", "status", "passenger_id", "flight_id",
                        "flight_number", "first_name", "last_name", "passport_no", "email", "departure_time",
                        "flight_status", "model", "airline_name", "src_name", "dst_name" },
    ...
    private ModuleConfig tickets(boolean a, boolean e, boolean d, String filter) {
        ...
        return new ModuleConfig("Tickets", "🎫", "Ticket", "ticket_id", q,
                new String[] { "ID", "Booking ID", "Passenger ID", "Seat ID", "Price", "Seat No", "Booking Ref",
                        "Passenger First Name", "Passenger Last Name", "Aircraft Model", "Airline Name", "Flight No",
                        "Source Airport", "Dest Airport" },
                new String[] { "ticket_id", "booking_id", "passenger_id", "seat_id", "price", "seat_number",
                        "booking_reference", "first_name", "last_name", "model", "airline_name", "flight_number",
                        "src_name", "dst_name" },
    ...
    private ModuleConfig payments(boolean a, boolean e, boolean d, String filter) {
        ...
        return new ModuleConfig("Payments", "💳", "Payment", "payment_id", q,
                new String[] { "ID", "Booking ID", "Amount", "Status", "Booking Ref", "Passenger First Name",
                        "Passenger Last Name", "Flight No", "Aircraft Model", "Airline Name" },
                new String[] { "payment_id", "booking_id", "amount", "payment_status", "booking_reference",
                        "first_name", "last_name", "flight_number", "model", "airline_name" },
    ...
    private ModuleConfig airportStaff(boolean a, boolean e, boolean d) {
        return new ModuleConfig("Airport Staff", "👷", "AirportStaff", "staff_id",
                ...
                new String[] { "ID", "First Name", "Last Name", "Role", "Airport ID", "Airport", "City", "Country",
                        "IATA" },
                new String[] { "staff_id", "first_name", "last_name", "role", "airport_id", "airport_name", "city",
                        "country", "iata_code" },
    ...
    private ModuleConfig flightStaff(boolean a, boolean e, boolean d) {
        return new ModuleConfig("Flight Staff", "👨‍✈️", "FlightStaff", "staff_id",
                ...
                new String[] { "ID", "First Name", "Last Name", "Role", "Flight ID", "Flight No", "Departure Time",
                        "Flight Status", "Aircraft Model", "Airline Name", "Source Airport", "Dest Airport" },
                new String[] { "staff_id", "first_name", "last_name", "role", "flight_id", "flight_number",
                        "departure_time", "flight_status", "model", "airline_name", "src_name", "dst_name" },
    ...
    private ModuleConfig users() {
        return new ModuleConfig("Users", "🔑", "Login", "login_id",
                ...
                new String[] { "ID", "Username", "Role", "Passenger ID", "Flight Staff ID", "Airport Staff ID",
                        "Passenger Name", "Flight Staff Name", "Airport Staff Name", "Flight Staff Flight No",
                        "Airport Staff Airport Name" },
                new String[] { "login_id", "username", "role", "passenger_id", "flight_staff_id", "airport_staff_id",
                        "pass_fname", "fs_fname", "ast_fname", "fs_flight_no", "ast_airport_name" },
